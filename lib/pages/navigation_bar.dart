  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      PersistentBottomNavBarItem(
          ...
          title: ("Home"),
          activeColorPrimary: lightColorScheme.primaryContainer,
          activeColorSecondary: lightColorScheme.onPrimaryContainer,
          inactiveColorPrimary: lightColorScheme.secondaryContainer,
          inactiveColorSecondary: lightColorScheme.onSecondaryContainer,
          iconSize: 24),
      PersistentBottomNavBarItem(
