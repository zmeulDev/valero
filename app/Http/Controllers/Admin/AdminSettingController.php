    ...
    public function update(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'app_seo_og_title' => 'nullable|string|max:255',
                'app_seo_og_description' => 'nullable|string|max:500',
                'app_seo_keywords' => 'nullable|string|max:255',
                ...
                'app_seo_title.required' => 'The SEO title is required.',
                'app_seo_title.max' => 'The SEO title must not exceed 255 characters.',
                'app_seo_description.required' => 'The SEO description is required.',
