<div class="bg-surface border border-border shadow-sm rounded-lg overflow-hidden">
    <!-- Header -->
    <div class="border-b border-border bg-background px-6 py-4">
        <h3 class="text-lg font-medium text-text flex items-center">
    ...
    <div class="p-6 space-y-6">
        ...
        <div>
            <div class="flex items-center justify-between mb-4">
                <h4 class="text-sm font-medium text-text flex items-center">
    ...
    : 'bg-yellow-100 text-yellow-800 dark:bg-yellow-800/20 dark:text-yellow-400' 
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="bg-background rounded-lg p-4">
                    <div class="text-sm font-medium text-muted mb-1">{{ __('admin.settings.last_updated') }}</div>
    ...
    : 'Never' }}
                ...
                <div class="bg-background rounded-lg p-4">
                    <div class="text-sm font-medium text-muted mb-1">{{ __('admin.settings.indexed_urls') }}</div>
                    <div class="text-sm text-text">
                        {{ file_exists(public_path('sitemap.xml'))
    ...
    : '0 URLs' }}
            ...
            <div class="bg-background rounded-lg p-4 mb-4">
                <label class="block text-sm font-medium text-text mb-2">{{ __('admin.settings.sitemap_url') }}</label>
                <div class="flex items-center space-x-2">
                    <input type="text" value="{{ url('sitemap.xml') }}" readonly
                        class="flex-1 text-sm bg-surface p-2 rounded border border-border focus:outline-none focus:ring-2 focus:ring-indigo-500 text-text">
        ...
        <div>
            <div class="flex items-center justify-between mb-4">
                ...
                <span
                    class="px-2.5 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800 dark:bg-blue-800/20 dark:text-blue-400">
