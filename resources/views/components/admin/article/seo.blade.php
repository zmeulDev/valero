...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">{{ __('admin.sidebar.seo_settings') }}
        </h3>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('admin.sidebar.seo_title_help') }}</p>
            </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <textarea name="seo_description" id="seo_description" rows="3"
                        ...
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md">{{ old('seo_description', $article?->seo?->description ?? '') }}</textarea>
                </div>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('admin.sidebar.seo_description_help') }}
                </p>
            </div>

            <!-- Canonical URL -->
            <div>
                <label for="seo_canonical_url" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <!-- Robots -->
            <div>
                <label for="seo_robots" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
    ...
    @if($article && $article->exists)
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden"
            ...
            <div class="px-4 py-5 sm:px-6 flex justify-between items-center cursor-pointer bg-gray-50 dark:bg-gray-700/50"
            ...
            <div x-show="isOpen" x-collapse class="border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="px-4 py-4 sm:px-6 grid grid-cols-3 gap-4">
                        ...
                        <dd class="text-sm text-gray-900 dark:text-gray-300 col-span-2">
                            <div class="space-y-1">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ $descriptionValidation['message'] }}
                                </p>
                            </div>
                        </dd>
                    </div>
