...
@else
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg  dark:border-gray-700 overflow-hidden"
        ...
        <div class="px-4 py-5 sm:px-6 flex justify-between items-center cursor-pointer"
            ...
            <button type="button" @click.prevent.stop="isOpen = !isOpen"
        ...
        <!-- Content -->
        <div class="border-t border-gray-200 dark:border-gray-700" x-show="isOpen"
            ...
            <dl class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div class="px-4 py-4 sm:px-6 grid grid-cols-3 gap-4">
                    ...
                    <dd class="text-sm text-gray-900 dark:text-gray-300 col-span-2">
                        <div class="space-y-2">
                            <img src="{{ $imageUrl }}" alt="{{ $coverMedia?->alt_text ?? $article->title }}"
                ...
                <div class="px-4 py-4 sm:px-6 grid grid-cols-3 gap-4">
                    ...
                    <dd class="text-sm text-gray-900 dark:text-gray-300 col-span-2 space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="{{ $contentValidation['is_optimal'] ? 'text-green-600 dark:text-green-400' : ($contentValidation['is_valid'] ? 'text-yellow-600 dark:text-yellow-400' : 'text-red-600 dark:text-red-400') }}">
                    ...
                    <div class="px-4 py-4 sm:px-6 grid grid-cols-3 gap-4">
                        ...
                        <dd class="text-sm text-gray-900 dark:text-gray-300 col-span-2 space-y-1">
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="{{ $keywordDensity['is_optimal'] ? 'text-green-600 dark:text-green-400' : 'text-yellow-600 dark:text-yellow-400' }}">
