                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <div class="py-1">
                                        ...
                                        <a href="{{ route('admin.playlists.index') }}"
                                            class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.playlists.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                            <div class="flex items-center">
