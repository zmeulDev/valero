<div class="relative bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl overflow-hidden mb-8 shadow-lg">
  ...
  <div class="relative z-1 p-6 sm:p-8 flex flex-col sm:flex-row items-center">
    ...
    <div class="sm:w-2/3">
      <span
        class="inline-block bg-yellow-400 text-gray-900 text-xs font-bold px-3 py-1 rounded-full mb-4">FEATURED</span>
  ...
  <a href="{{ route('articles.show', $article->slug) }}"
    class="absolute bottom-4 right-4 bg-yellow-400 text-gray-900 px-4 py-2 rounded-full font-bold hover:bg-yellow-300 transition-colors duration-150 z-1">
    Read Now
  </a>
</div>