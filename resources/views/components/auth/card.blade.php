<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-background">
    <div class="w-full max-w-6xl">
        <div class="grid md:grid-cols-2 gap-8 items-center">
            <!-- Logo/Branding Side -->
            <div class="hidden md:flex flex-col items-center justify-center p-8 bg-surface rounded-2xl shadow-xl">
                    ...
                    <div class="mt-8 space-y-4">
                        ...
                        <div class="pt-8">
                            <img src="{{ asset('storage/brand/auth_background.png') }}"
                                alt="{{ __('frontend.auth.auth_image') }}" class="w-full h-auto rounded-xl opacity-90"
            ...
            <!-- Form Side -->
            <div class="w-full">
                <div class="bg-surface rounded-2xl shadow-2xl p-8 sm:p-10 border border-border">
                    <!-- Mobile Logo -->
