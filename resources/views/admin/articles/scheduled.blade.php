        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            @if($articles->isEmpty())
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('admin.articles.get_started_by_creating_a_new_article') }}</p>
                    <div class="mt-6">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            <span>•</span>
                                            <span>{{ __('admin.articles.scheduled_for') }} {{ $article->scheduled_at->format('M d, Y H:i') }}</span>
                                        </div>
                                    </div>
