    ...
    <div class="container mx-auto px-4 lg:px-8">
      <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('admin.articles.create') }}"
          class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md shadow-sm transition">Create
          New Article</a>
      </div>
          ...
          <tbody class="text-gray-700 text-sm">
            ...
            <tr class="border-b hover:bg-gray-50 transition">
              <td class="px-6 py-4">
                ...
                @else
                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text-gray-800">No
                  Image</span>
                @endif
              </td>
