                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-4">
                                    <img src="{{ asset('storage/brand/logo.png') }}" alt="Current Logo" class="h-32 w-32 object-cover rounded-lg border border-gray-300 shadow-md transition-transform duration-200 transform hover:scale-105">
                                </div>
                            </div>
