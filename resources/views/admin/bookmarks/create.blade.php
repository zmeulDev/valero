<x-admin-layout>
    <x-slot name="header">
        <x-admin.page-header
            icon="bookmark-plus"
            title="{{ __('admin.bookmarks.create') }}"
            description="{{ __('admin.bookmarks.create_description') }}"
            :breadcrumbs="[
                ['label' => __('admin.bookmarks.breadcrumbs'), 'url' => route('admin.bookmarks.index')],
                ['label' => __('admin.bookmarks.new_bookmark')]
            ]"
        >
            <x-slot:actions>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                <form action="{{ route('admin.bookmarks.store') }}" 
                      method="POST"
                      class="p-6"
                      x-data="{
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <button type="submit" 
                            ...
                            {{ __('admin.bookmarks.save_bookmark') }}
                        </button>
                    </div>
                </form>
            </div>
